...
criaCartao(
    'Passeios', 
    'Onde passear?', 
    'Catedral de Berlim é o edifício religioso mais representativo da cidade. Sua cúpula oferece as melhores vistas de Berlim. A Catedral de Berlim (Berliner Dom) se levanta majestosa nas proximidades do Rio Spree, coroada por uma cúpula de cobre de cor esverdeada.'
)

criaCartao(
    'Prato Típico', 
    'Conhece o "Pretzel"?', 
    'Pretzel Descrição: Um pão salgado em formato trançado, com uma crosta dourada e textura macia por dentro. Significado Cultural: Um ícone da culinária alemã, frequentemente servido com cerveja. Receita Simples: Ingredientes: Farinha, água, fermento, manteiga, bicarbonato de sódio e sal grosso. Substituições: Sal grosso pode ser trocado por sementes de gergelim.'
)
